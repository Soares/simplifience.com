...
(function() {
  ...
  Uriel.Axis = (function() {
    function Axis(paper, _arg, options) {
      var extensionLength, n, neglength, negunits, poslength, posunits, _i, _len, _ref;
      this.paper = paper;
      ...
      _ref = this.ticks(options.from.end, options.to.end, options.step);
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        n = _ref[_i];
  ...
  Uriel.LinearRecipe = (function() {
    ...
    LinearRecipe.prototype.triggerOnView = function(delay, options) {
      ...
      return this.elem.waypoint(((function(_this) {
        return function() {
