...
(function() {
  ...
  ComplexPlane = (function(_super) {
    ...
    function ComplexPlane(elem, options) {
      ...
      this.makeHorizontalAxis = function() {
        return ComplexPlane.prototype.makeHorizontalAxis.apply(_this, arguments);
      };
      this.setup = function() {
  ...
  Compound = (function(_super) {
    ...
    function Compound(elem) {
      var doAll, unit, _ref, _ref1, _ref2, _ref3,
        _this = this;
      this.setup = function() {
        return Compound.prototype.setup.apply(_this, arguments);
      };
      this.draw = function(i) {
        return Compound.prototype.draw.apply(_this, arguments);
      };
      this.drawAll = function() {
        return Compound.prototype.drawAll.apply(_this, arguments);
      };
      this.scale = function(factor) {
        return Compound.prototype.scale.apply(_this, arguments);
      };
  ...
  Tangents = (function(_super) {
    ...
    function Tangents(elem) {
      var _this = this;
      this.makeVerticalAxis = function() {
        return Tangents.prototype.makeVerticalAxis.apply(_this, arguments);
      };
      this.makeHorizontalAxis = function() {
        return Tangents.prototype.makeHorizontalAxis.apply(_this, arguments);
      };
      this.setup = function() {
        return Tangents.prototype.setup.apply(_this, arguments);
      };
    ...
    Tangents.prototype.setup = function() {
      var circle, dot, dotAnim, path, radius, tangentAnim,
        _this = this;
      this.rule([1, -3], [1, 3]);
      this.paper.ca.tangent = (function(turns) {
