...
(function() {
  ...
  ComplexPlane = (function(_super) {
    ...
    function ComplexPlane(elem) {
      var _this = this;
      this.makeVerticalAxis = function() {
        return ComplexPlane.prototype.makeVerticalAxis.apply(_this, arguments);
      };
      this.labelZero = function() {
        return ComplexPlane.prototype.labelZero.apply(_this, arguments);
      };
      this.setup = function() {
        return ComplexPlane.prototype.setup.apply(_this, arguments);
      };
  ...
  PolarPlane = (function(_super) {
    ...
    function PolarPlane(elem) {
      var _this = this;
      this.setup = function() {
        return PolarPlane.prototype.setup.apply(_this, arguments);
      };
      this.drawGuides = function() {
        return PolarPlane.prototype.drawGuides.apply(_this, arguments);
      };
      this.makeVerticalAxis = function() {
        return PolarPlane.prototype.makeVerticalAxis.apply(_this, arguments);
      };
      this.makeHorizontalAxis = function() {
        return PolarPlane.prototype.makeHorizontalAxis.apply(_this, arguments);
      };
  ...
  OnePlane = (function(_super) {
    ...
    function OnePlane(elem) {
      var _this = this;
      this.setup = function() {
        return OnePlane.prototype.setup.apply(_this, arguments);
      };
      this.drawGuides = function() {
        return OnePlane.prototype.drawGuides.apply(_this, arguments);
      };
      this.makeVerticalAxis = function() {
        return OnePlane.prototype.makeVerticalAxis.apply(_this, arguments);
      };
      this.makeHorizontalAxis = function() {
        return OnePlane.prototype.makeHorizontalAxis.apply(_this, arguments);
      };
