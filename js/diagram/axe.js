  ...
  AxeRadar = (function(_super) {
    ...
    function AxeRadar(elem) {
      var cx, cy, dx, dy, spread, turns, u, v, x, y, _ref, _ref1,
        _this = this;
      this.line = function(turns) {
        return AxeRadar.prototype.line.apply(_this, arguments);
      };
      this.guide = function(radius) {
        return AxeRadar.prototype.guide.apply(_this, arguments);
      };
      this.dot = function(label, x, y, radius, color) {
        return AxeRadar.prototype.dot.apply(_this, arguments);
      };
